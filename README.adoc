...
**!!! This is a DRAFT for a future curriculum. It has not been sanctioned by the iSAQB Council yet. !!!**
...
== Status 
image:https://github.com/isaqb-org/curriculum-dsl/workflows/CI%20-%20Releases%20and%20Master/badge.svg?branch=master["CI – Releases and Master"]
image:https://img.shields.io/github/last-commit/isaqb-org/curriculum-dsl/master.svg["Last commit"]
