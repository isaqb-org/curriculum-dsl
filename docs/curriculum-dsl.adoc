...
<<<
:sectnums:
include::02-Syntax/00-structure.adoc[{include_configuration}]

<<<
include::03-Semantics/00-structure.adoc[{include_configuration}]

<<<
include::04-Language-Design/00-structure.adoc[{include_configuration}]

<<<
include::05-Tools/00-structure.adoc[{include_configuration}]
