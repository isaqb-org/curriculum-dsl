...
<<<
:sectnums:
include::01-Syntax/00-structure.adoc[{include_configuration}]

<<<
include::02-Semantics/00-structure.adoc[{include_configuration}]

<<<
include::03-Language-Design/00-structure.adoc[{include_configuration}]

<<<
include::04-Tools/00-structure.adoc[{include_configuration}]

<<<
include::05-Case-Study/00-structure.adoc[{include_configuration}]
